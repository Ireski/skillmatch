const Category = () => {
  return (
    <div className="px-4 lg:px-16 lg:py-32 py-5 pt-24">
        ...
        Connect with talented freelancers across various fields. Our platform offers a diverse range of services to meet your project needs.
        </p>
        <div>
          <button className="bg-orange-600 border-orange-600 text-white px-6 py-2 mx-2 rounded-lg">
            Post A Job
          </button>
          <button className="text-black text-lg px-6 py-2 mx-2 border-none">
