...
const Nav = () => {
  ...
  return (
    <div
      ...
      className="fixed top-0 left-0 w-[97%] z-50 bg-white flex justify-between items-center h-20 w-full mx-auto lg:px-16 px-6 text-black border-b border-b-gray-300"
    >
      {/* Logo */}
